...
{
	public static String MSG_ERR_NUM_ARG = "Error. Three argument required.";
	public static String EXAMPLE_ARGS = "Example: java Program . 0 /home/dan/Desktop/it.bmp";
	public static String DETAILS = "Arguments == <character is used for white color> <character is used for black color> <full path to the image on your disk>";
